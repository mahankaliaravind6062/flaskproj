...
gj.tree.methods = {
    ...
    appendNode: function ($tree, $parent, nodeData, level, position) {
		...
		$wrapper.append($('<a><span onclick="addnotes(this)"> <i class="fa fa-sticky-note"></i> Instructions</span></a>'));
        $node.append($wrapper);
...
gj.checkbox.methods = {
    ...
    initialize: function ($chkb) {
        var data = $chkb.data(), $wrapper, $span;//,$extraelement;
		...
		//$extraelement = $('<span class="glyphicons glyphicons-note"></span>');
